...
class ATACControllerViewPluginConan(ConanFile):
    ...
    name = "ATACViewPlugin"
    description = """Plugins for displaying ATACView in ManiVaultStudio."""
    topics = ("hdps", "plugin")
    url = "https://github.com/ManiVaultStudio/ATACViewPlugin"
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="hdps/ATACViewPlugin")
        cmake.verbose = True
        return cmake
